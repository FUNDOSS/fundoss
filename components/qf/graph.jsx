...
function Graph({
  ...
  return (
    <svg
      ...
      onClick={(e) => {
        onMouseEvent(e);
        if (click) click(Math.round(coord.x));
      }}
      onMouseLeave={
        () => setFocus(false)
      }
    >
      ...
      {!minimal ? (
        <>
          ...
          <path d={`M ${10 + Number(averageDonation)} 10 V ${height - 10}`} stroke="#20c997" />
          ...
          <text x={(20 + Number(averageDonation))} y="70" style={{ fill: '#20c997', fontSize: '12px' }}>
